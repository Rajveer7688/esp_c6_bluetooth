  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: IconButton(
        ...
        style: IconButton.styleFrom(backgroundColor: isActive ? TColors.primary.withValues(alpha: 0.8) : TColors.darkGrey.withValues(alpha: 0.8), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(40))),
      ),
    );
  }
}